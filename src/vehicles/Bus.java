...
public class Bus extends PublicTransport {
     ...
     *
     * where {registration} is replaced by the registration number of this bus,
     ...
     *
     * Specified by:
     * encode in interface Writeable
     * Overrides:
     * encode in class PublicTransport
     * @return This bus encoded as a string.
     */
    public String encode() {

        return String.format("%s,%s", super.encode(),getRegistrationNumber());
    }
